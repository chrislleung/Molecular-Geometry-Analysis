...
public class CenterFinder3 { //modified CenterFinder to fit the pyramidal program
    private ArrayList<Double> x = new ArrayList<Double>();
    private ArrayList<Double> y = new ArrayList<Double>();
    private ArrayList<Double> z = new ArrayList<Double>();
    private int count;

    public CenterFinder3(String filename, ArrayList<Integer> atomList) throws IOException{
