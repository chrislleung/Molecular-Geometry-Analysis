...
public class AngleCalc {
    ...
    private static double[] plane1;
    private static double[] plane2;
    private static double[] atom;
    private double radians;
    private double angle;

    public AngleCalc(String savedString, int point1, int point2, int point3, int point4, int point5, int point6) throws IOException {
        /*
        ...
        */
        ...
        radians = Math.acos(dotProduct);

        System.out.println("\nThe angle is: " + radians +" radians");
